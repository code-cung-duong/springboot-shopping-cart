...
<nav class="navbar header-navbar pcoded-header">
	<div class="navbar-wrapper">
		<div class="navbar-logo">
			...
			<a href="/admin/home"> <img class="img-fluid"
				src="admin/assets/images/logo.png" alt="Theme-Logo" />
			...
			<ul class="nav-right">
				<li class="header-notification"><a href="#!"
					...
					<ul class="show-notification">
						...
						<li class="waves-effect waves-light">
							<div class="media">
								<img class="d-flex align-self-center img-radius"
									src="admin/assets/images/avatar-4.jpg"
									alt="Generic placeholder image">
								<div class="media-body">
						...
						<li class="waves-effect waves-light">
							<div class="media">
								<img class="d-flex align-self-center img-radius"
									src="admin/assets/images/avatar-3.jpg"
									alt="Generic placeholder image">
								<div class="media-body">
				...
				<li class="user-profile header-notification"><a href="#!"
					class="waves-effect waves-light"> <img
						src="admin/assets/images/author.jpg" class="img-radius"
						alt="User-Profile-Image"> <span><%=SecurityUtils.getPrincipal().getFullName()%></span>
					...
					<ul class="show-notification profile-notification">
						...
						<li class="waves-effect waves-light"><a href=""> <i
								class="ti-user"></i> Profile
						</a></li>
						<li class="waves-effect waves-light"><a href=""> <i
								class="ti-email"></i> My Messages
						</a></li>
						<li class="waves-effect waves-light"><a href=""> <i
								class="ti-lock"></i> Lock Screen
						</a></li>
						<li class="waves-effect waves-light"><a href="/logout"> <i
