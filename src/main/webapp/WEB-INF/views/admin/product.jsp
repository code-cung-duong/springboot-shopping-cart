									...
									<div class="col-md-8">
										<div class="page-header-title">
											...
											<c:if test="${not empty param.keyword}">
												<p class="m-b-0">${products.totalItem} results found</p>

											</c:if>

											<c:if test="${empty param.keyword}">
												<p class="m-b-0">There are ${products.totalItem}
													products</p>
											</c:if>
										</div>
									</div>
													...
													<div class="card-header">
														...
														<div class="card-header-right">
															<ul class="list-unstyled card-option">
																...
																<li><a href="/admin/edit_product"><i
																		title="Insert" class="fa fa-plus" aria-hidden="true"></i></a></li>
																<li><i title="Edit" class="fa fa-pencil-square-o"
																	aria-hidden="true"></i></li>
																<li><a onclick="warningBeforeDelete()"><i
																		title="Delete" class="fa fa-trash-o"
													...
													<div class="accordion-panel">
														<div class="accordion-heading" role="tab" id="headingOne">
															<h3 class="card-title accordion-title">
																<a
																	...
																	aria-controls="collapseOne"> <i class="fa fa-bars"
																	style="float: left;" aria-hidden="true"></i><i
																	class="fa fa-bars" style="float: right;"
														...
														<div id="collapseOne" class="panel-collapse in collapse"
															...
															<div class="accordion-content accordion-desc">
																<form action="/admin/product" autocomplete="off">
																	<div class="row">
																		...
																		<c:forEach var="item" items="${products.listResult}">
																			<tr>
																				<th scope="row"><input type="checkbox"
																					value="${item.id}" /></th>
																				<td><img
																					style="width: 88px; height: 111px; object-fit: cover;"
																					src="web/img/product/${item.image}"></td>
																				<td>${item.name}</td>
																				<td>${item.price}</td>
																				...
																				<td><a href="/admin/edit_product?id=${item.id}"><i
